...
var Session = (_class = class {
  ...
  /** @internal */
  constructor(postFn, userId, userInfo, organizationId, localDev) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    assertNonEmpty(userId, "userId");
    this.#postFn = postFn;
    this.#userId = userId;
    this.#userInfo = userInfo;
    this.#organizationId = organizationId;
    this.#localDev = _nullishCoalesce(localDev, () => ( false));
  }
  #getOrCreate(roomId) {
    if (this.#sealed) {
...
var Liveblocks = class {
  ...
  async identifyUser(identity, ...rest) {
    ...
    try {
      ...
      return {
        status: 503,
        body: this.#localDev ? "Could not connect to your Liveblocks dev server. Is it running?" : `Call to ${_core.urljoin.call(void 0, 
          this.#baseUrl,
          path
  ...
  async setPresence(roomId, params, options) {
    const res = await this.#post(
      _core.url`/v2/rooms/${roomId}/presence`,
      {
        userId: params.userId,
        data: params.data,
