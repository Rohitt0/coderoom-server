...
type CreateFeedMessageOptions<FMD extends Json = DFMD> = {
    id?: string;
    /** Creation time in ms; serialized as `timestamp` in the REST request body. */
    createdAt?: number;
    data: FMD;
};
type UpdateFeedMessageOptions<FMD extends Json = DFMD> = {
    data: FMD;
...
declare class Liveblocks {
     ...
     */
    getFeeds<FM extends Json = DFM>(params: {
        roomId: string;
    }, options?: RequestOptions): Promise<{
        data: Feed<FM>[];
    }>;
     ...
     */
    createFeed<FM extends Json = DFM>(params: {
        roomId: string;
    } & CreateFeedOptions, options?: RequestOptions): Promise<Feed<FM>>;
    /**
     ...
     * @returns The feed.
     */
    getFeed<FM extends Json = DFM>(params: {
        roomId: string;
        feedId: string;
     ...
     */
    updateFeed<FM extends Json = DFM>(params: {
        roomId: string;
        feedId: string;
    } & UpdateFeedOptions, options?: RequestOptions): Promise<Feed<FM>>;
    /**
     * Deletes a feed.
     ...
     */
    getFeedMessages<FMD extends Json = DFMD>(params: {
        roomId: string;
        feedId: string;
    }, options?: RequestOptions): Promise<{
     ...
     */
    createFeedMessage<FMD extends Json = DFMD>(params: {
        roomId: string;
        feedId: string;
     ...
     */
    updateFeedMessage<FMD extends Json = DFMD>(params: {
        roomId: string;
        feedId: string;
        messageId: string;
    } & UpdateFeedMessageOptions<FMD>, options?: RequestOptions): Promise<FeedMessage<FMD>>;
    /**
